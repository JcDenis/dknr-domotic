...
cp -rf /data/projects/dknr-domotic/package.json /data/package.json
cp -rf /data/projects/dknr-domotic/data/settings.js /data/settings.js
cp -rf /data/projects/dknr-domotic/data/.config.projects.json /data/.config.projects.json
cp -rf /data/projects/dknr-domotic/data/admin.png /data/admin.png
